...
git checkout -b v7.2/standard/genericarm64-phyboard-pollux-imx8mp-3 official-upstream/v7.2/standard/genericarm64

use this:
push-all-to-github.sh

only if this fails use:
push-in-pieces.sh


since they both point to the same branch do this afterwards:
./push-all-to-github.sh
